...
import { isMobileDevice, getMobileRayStepCap, getHardwareInfo } from '@/utils/device-detection';
...
describe('Adaptive Systems - Integration Tests', () => {
    ...
    describe('Settings Persistence Integration', () => {
        ...
        it('should handle corrupted localStorage data gracefully', () => {
            ...
            const corruptedStorage = new SettingsStorage(storageKey, `${storageKey}-preset`);
    ...
    describe('Mobile Detection Integration', () => {
        beforeEach(() => {
            ...
            navigatorMock.userAgent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36';
            windowMock.innerWidth = 1920;
        });

        it('should detect mobile devices correctly', () => {
            // Test mobile user agent
            navigatorMock.userAgent = 'Mozilla/5.0 (iPhone; CPU iPhone OS 14_0 like Mac OS X)';
