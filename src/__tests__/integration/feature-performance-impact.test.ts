 ...
 */
function applyPreset(preset: PresetName, currentParams: SimulationParams): SimulationParams {
...
describe('Feature Performance Impact - Integration Tests', () => {
    ...
    describe('Cumulative Feature Impact', () => {
        ...
        it('should show maximum performance gain when all features are disabled', () => {
            ...
            const reductionPercent = ((frameTimeAll - frameTimeNone) / frameTimeAll) * 100;
    ...
    describe('Performance Warning Thresholds', () => {
        it('should trigger warning when FPS drops below 60', () => {
            ...
            expect(warnings.some(w => w.message.includes('Performance warning'))).toBe(true);
        });
        ...
        it('should trigger critical warning when FPS drops below 30', () => {
            ...
            expect(warnings.some(w => w.message.includes('Critical performance issue'))).toBe(true);
        });
        ...
        it('should not trigger warnings when FPS is above 60', () => {
            ...
            const performanceWarnings = warnings.filter(w =>
                w.severity === 'warning' || w.severity === 'critical'
            );
        ...
        it('should provide appropriate suggestions for performance warnings', () => {
            ...
            const hasLensingOrQuality = warningMessages.some(s =>
        ...
        it('should trigger frame budget warning when exceeding 13.3ms', () => {
            ...
            expect(warnings.some(w => w.message.includes('Frame time budget'))).toBe(true);
        });
