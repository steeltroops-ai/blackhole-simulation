...
import { getMobilePreset, getPreset, PERFORMANCE_PRESETS } from '@/types/features';
...
describe('Mobile Feature Optimization', () => {
    ...
    describe('Property 19: Mobile device preset', () => {
        it('applies balanced preset configuration for mobile', () => {
            ...
            expect(mobilePreset.gravitationalLensing).toBe(balancedPreset.gravitationalLensing);
            expect(mobilePreset.rayTracingQuality).toBe(balancedPreset.rayTracingQuality);
            ...
            expect(mobilePreset.photonSphereGlow).toBe(balancedPreset.photonSphereGlow);
        });
    ...
    describe('Mobile preset validation', () => {
        ...
        it('mobile preset has valid property types', () => {
            ...
            expect(['off', 'low', 'medium', 'high', 'ultra']).toContain(mobilePreset.rayTracingQuality);
        });
    });
});
