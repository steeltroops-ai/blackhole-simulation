...
describe('Property 24: Quality auto-adjustment', () => {
     ...
     */
    function shouldReduceQuality(fps: number, consecutiveFrames: number): boolean {
    ...
    test('quality does not change when FPS is good', () => {
        fc.assert(
            fc.property(
                fc.constantFrom('low' as QualityLevel, 'medium' as QualityLevel, 'high' as QualityLevel),
