...
describe('Property 15: Camera angle updates', () => {
    ...
    function updateCameraAngles(
        ...
        let newTheta = theta + deltaX * sensitivity;
        ...
        fc.assert(
            fc.property(
                ...
                (theta, phi, deltaX) => {
                    ...
                    const result = updateCameraAngles(theta, phi, deltaX, 0, sensitivity);
    ...
    test('phi updates proportionally to deltaY when not at boundaries', () => {
        fc.assert(
            fc.property(
                ...
                (theta, phi, deltaY) => {
                    const sensitivity = 0.005;
                    const result = updateCameraAngles(theta, phi, 0, deltaY, sensitivity);
        ...
        fc.assert(
            fc.property(
                ...
                (theta, deltaY) => {
                    ...
                    const result = updateCameraAngles(theta, phi, 0, deltaY);
...
describe('Property 17: Single touch camera rotation', () => {
     ...
     */
    function updateCameraFromTouch(
        theta: number,
        phi: number,
        touchDeltaX: number,
        touchDeltaY: number,
        ...
        let newTheta = theta + touchDeltaX * sensitivity;
    ...
    test('single touch updates camera angles proportionally', () => {
        fc.assert(
            fc.property(
                ...
                (theta, phi, deltaX, deltaY) => {
                    const result = updateCameraFromTouch(theta, phi, deltaX, deltaY);
    ...
    test('single touch respects phi bounds', () => {
        fc.assert(
            fc.property(
                ...
                (theta, phi, deltaY) => {
                    const result = updateCameraFromTouch(theta, phi, 0, deltaY);
...
describe('Property 20: Two-finger pan', () => {
    ...
    function updateCameraFromPan(
        ...
        let newTheta = theta + panDeltaX * sensitivity;
    ...
    test('pan updates camera angles based on center movement', () => {
        fc.assert(
            fc.property(
                ...
                (theta, phi, deltaX, deltaY) => {
                    const result = updateCameraFromPan(theta, phi, deltaX, deltaY);
    ...
    test('horizontal pan affects theta', () => {
        fc.assert(
            fc.property(
                ...
                (theta, phi, deltaX) => {
                    const result = updateCameraFromPan(theta, phi, deltaX, 0);
    ...
    test('vertical pan affects phi within bounds', () => {
        fc.assert(
            fc.property(
                ...
                (theta, phi, deltaY) => {
                    const result = updateCameraFromPan(theta, phi, 0, deltaY);
