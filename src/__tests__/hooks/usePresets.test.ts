...
import { getPreset, matchesPreset, PERFORMANCE_PRESETS } from '@/types/features';
...
describe('Preset Application Logic', () => {
    ...
    const applyPreset = (preset: string, params: SimulationParams): SimulationParams => {
        const features = getPreset(preset as any);
        return {
            ...params,
            features,
            performancePreset: preset,
            quality: features.rayTracingQuality === 'off' || features.rayTracingQuality === 'low'
                ? 'low'
    ...
    describe('applyPreset', () => {
        it('should apply maximum-performance preset correctly', () => {
            ...
            expect(updatedParams.features).toEqual(PERFORMANCE_PRESETS['maximum-performance']);
        ...
        it('should apply high-quality preset correctly', () => {
            ...
            expect(updatedParams.features).toEqual(PERFORMANCE_PRESETS['high-quality']);
        ...
        it('should apply ultra-quality preset correctly', () => {
            ...
            expect(updatedParams.features).toEqual(PERFORMANCE_PRESETS['ultra-quality']);
    ...
    describe('detectPreset', () => {
        it('should detect maximum-performance preset', () => {
            const detected = matchesPreset(PERFORMANCE_PRESETS['maximum-performance']);
    ...
    describe('preset application workflow', () => {
        it('should allow switching between presets', () => {
            ...
            expect(params.features).toEqual(PERFORMANCE_PRESETS['maximum-performance']);
