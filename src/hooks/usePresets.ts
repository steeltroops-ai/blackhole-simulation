...
import { getPreset, matchesPreset, type PresetName, type FeatureToggles } from '@/types/features';
import type { SimulationParams } from '@/types/simulation';

interface UsePresetsReturn {
    applyPreset: (preset: PresetName, currentParams: SimulationParams) => SimulationParams;
...
export const usePresets = (): UsePresetsReturn => {
     ...
     */
    const applyPreset = useCallback((preset: PresetName, currentParams: SimulationParams): SimulationParams => {
        ...
        return {
            ...
            // Update quality based on ray tracing quality
